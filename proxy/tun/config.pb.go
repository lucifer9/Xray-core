...
type Config struct {
	...
	EnableIcmpForwarding bool     `protobuf:"varint,10,opt,name=enable_icmp_forwarding,json=enableIcmpForwarding,proto3" json:"enable_icmp_forwarding,omitempty"`
...
const file_proxy_tun_config_proto_rawDesc = "" +
	"\n" +
	"\x16proxy/tun/config.proto\x12\x0exray.proxy.tun\"\xe8\x02\n" +
	"\x06Config\x12\x12\n" +
	...
	"\rroute_exclude\x18\t \x03(\tR\frouteExclude\x124\n" +
	"\x16enable_icmp_forwarding\x18\n" +
	" \x01(\bR\x14enableIcmpForwardingBL\n" +
