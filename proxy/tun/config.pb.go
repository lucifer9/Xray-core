...
type Config struct {
	...
	EnableIcmpForwarding   bool                   `protobuf:"varint,8,opt,name=enable_icmp_forwarding,json=enableIcmpForwarding,proto3" json:"enable_icmp_forwarding,omitempty"`
...
func (x *Config) GetEnableIcmpForwarding() bool {
	if x != nil {
		return x.EnableIcmpForwarding
	}
	return false
}
...
const file_proxy_tun_config_proto_rawDesc = "" +
	"\n" +
	"\x16proxy/tun/config.proto\x12\x0exray.proxy.tun\"\xa4\x02\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x18auto_outbounds_interface\x18\a \x01(\tR\x16autoOutboundsInterface\x124\n" +
	"\x16enable_icmp_forwarding\x18\b \x01(\bR\x14enableIcmpForwardingBL\n" +
